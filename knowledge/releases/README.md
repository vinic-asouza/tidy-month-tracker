...
| --- | --- | --- | --- |
| v0.4.0 | 2026-09-07 | Publicado | [v0.4.0-2026-09-07.md](./v0.4.0-2026-09-07.md) |
| v0.3.1 | 2026-09-04 | Publicado | [v0.3.1-2026-09-04.md](./v0.3.1-2026-09-04.md) |
...
- SemVer: última publicada é `v0.3.1`. Próxima Draft = **MINOR** `v0.4.0` (lote DEV-50). Depois: PATCH `v0.4.1` ou MINOR se feature.
...
Próxima nota após publicar `v0.3.1`: **PATCH** `v0.3.2` na próxima PR para `main`, salvo MINOR/MAJOR justificados, ou **v1.0.0** no go-live público.
